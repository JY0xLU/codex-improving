...
2. Do not rewrite long-term memory while solving the current task

Off-hours and maintenance:
1. Prefer subagent review for promotion, rejection, archive, or conflict decisions
...
4. Never auto-edit this `AGENTS.md`; only propose changes for human review
